<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Production.aspx.cs" Inherits="StarsProject.Production" MaintainScrollPositionOnPostback="true" %>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div runat="server" clientidmode="Static" class="input-field col m3">
                                            ...
                                            <label class="active" for="txtProductNameOuter">Select Finish Product</label>
                                            <asp:TextBox ID="txtProductNameOuter" runat="server" ClientIDMode="Static" class="form-control" onKeyup="bindDDLProductToOuter('#txtProductNameOuter')" AutoPostBack="true" TabIndex="12" Width="95%" PlaceHolder=""/>
                                        </div>
                                        <div id="div1" runat="server" clientidmode="Static" class="input-field col m1">
                                            <button id="btnLoadAssembly" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn cyan right mr-1" onserverclick="btnLoadAssembly_ServerClick">Load Assembly Products</button>
                                        </div>
                                        <div runat="server" clientidmode="Static" class="input-field col m1">
                                            <label class="active" for="txtQuantity">Quantity</label>
                                            <asp:TextBox ID="txtQuantity" runat="server" ClientIDMode="Static" class="form-control" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" TabIndex="12" Width="95%" PlaceHolder=""/>
                                        </div>
                                        <div runat="server" clientidmode="Static" class="input-field col m4">
                                            <label class="active" for="txtRemarks">Remarks</label>
                                            <asp:TextBox ID="txtRemarks" runat="server" ClientIDMode="Static" class="form-control" Width="400px" TabIndex="12" PlaceHolder=""/>
                                        </div>
                                    </div>
                                                        ...
                                                        <asp:Repeater ID="rptPro" runat="server" ClientIDMode="Static" OnItemCommand="rptPro_ItemCommand" OnItemDataBound="rptPro_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <asp:HiddenField ID="edFinishedProID" runat="server" ClientIDMode="Static" Value='<%# Eval("FinishedProductID") %>' />
                                                                    ...
                                                                    <td class="center-align width-10">
                                                                        <asp:TextBox ID="edQuantity" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>'  Style="width: 80px; text-align: center;" AutoPostBack="true" OnTextChanged="editItem_TextChanged" TabIndex="6"/>
                                                                    </td>
                                                                    <td class="center-align width-10">
