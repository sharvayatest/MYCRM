<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractInfo.aspx.cs" Inherits="StarsProject.ContractInfo" %>
    ...
    <script type="text/javascript">
        ...
        function getAMCType() {
            $('#drpContractType, #txtStartDate').bind('change', function () {
                ...
                if ($('#drpContractType').val().toLowerCase() == '3 months') {
                ...
                if ($('#drpContractType').val().toLowerCase() == '9 months') {
                                ...
                                <div class="col m5" style="border-right: 3px ridge silver;">
                                    <div class="row">
                                        <div class="input-field col m6">
                                            <label class="active" for="txtContractCode">Contract Code #</label>
                                            <asp:TextBox ID="txtContractCode" runat="server" placeholder="" class="form-control" ClientIDMode="Static" TabIndex="1" ReadOnly="true" />
                                        </div>
                                        <div class="input-field col m6">
                                            <label class="active" for="drpContractType">Contract Type</label>
                                            <asp:DropDownList ID="drpContractType" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="2">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m6">
                                            <label class="active" for="drpContactPerson">Contact Person</label>
                                            <asp:DropDownList ID="drpContactPerson" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="4" />
                                        </div>
                                        <div class="input-field col m6">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m6">
                                            ...
                                            <asp:TextBox ID="txtStartDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="6" onkeypress="return false;" placeholder="" TextMode="Date" />
                                        </div>
                                        <div class="input-field col m6">
                                            <label class="active" for="txtEndDate">End Date</label>
                                            <asp:TextBox ID="txtEndDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="7" onkeypress="return false;" placeholder="" TextMode="Date" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col m7">
                                    <div class="row">
                                        <div class="col s12">
                                            <ul id="myTab" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color: antiquewhite;">
                                                <li class="tab col m6 p-0"><a id="lnkProducts" class="left active" href="#pnl_Products">Product Detail</a></li>
                                                <li class="tab col m6 p-0"><a id="lnkTNC" class="left" href="#pnl_TNC">Terms & Coditions</a></li>
                                            </ul>
                                        </div>
                                                ...
                                                <ContentTemplate>
                                                    <asp:Panel runat="server" ID="pnlDetail">
                                                        ...
                                                        <table id="tblInqProductGroup" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <asp:Repeater ID="rptContractInfoProductGroup" runat="server" ClientIDMode="Static" OnItemCommand="rptContractInfoProductGroup_ItemCommand" OnItemDataBound="rptContractInfoProductGroup_ItemDataBound">
                                                                <HeaderTemplate>
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="text-left">Product Name <span class="materialize-red-text font-weight-800">*</span>
                                                                                ...
                                                                                <a href="javascript:openProductInfo('add');">
                                                                                    <img src="images/expand.png" width="30" height="20" style="padding: 5px 5px 0px 10px;" alt="Add New Product" title="Add New Product" tabindex="8" />
                                                                                </a>
                                                                            </th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td id="tdUnitPrice" class="text-right"><%# Eval("UnitPrice") %></td>
                                                                        <td id="tdQuantity" class="text-right"><%# Eval("Quantity") %></td>
                                                                        <td class="text-right"><%#  String.Format("{0:0.00}", Convert.ToDecimal(Eval("UnitPrice")) *  Convert.ToDecimal(Eval("Quantity"))) %></td>
                                                                ...
                                                                <FooterTemplate>
                                                                    <tr style="padding: 5px;">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <asp:TextBox ID="txtUnitPrice" runat="server" ClientIDMode="Static" Width="80" TabIndex="9" />
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <asp:TextBox ID="txtQuantity" runat="server" ClientIDMode="Static" Width="80" TabIndex="10" MaxLength="15" />
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <asp:Label ID="lblAmount" runat="server" ClientIDMode="Static" Width="80" TabIndex="11" Enabled="false" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                    ...
                                                                    <tr style="display: none; background-color: navy; min-height: 50px;">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <asp:Label ID="lblTotalAmount" runat="server" ClientIDMode="Static" Width="80" TabIndex="13" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                        </td>
                                                                        <td></td>
                                                                    </tr>
                                                                </FooterTemplate>
