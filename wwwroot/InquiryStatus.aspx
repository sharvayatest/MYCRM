<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InquiryStatus.aspx.cs" Inherits="StarsProject.InquiryStatus" %>
                                ...
                                <div class="row">
                                    <div class="input-field col m6">
                                        <asp:DropDownList ID="drpCategory" runat="server" class="select2-theme browser-default" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem Text="Lead Status" Value="Inquiry" />
                                            <asp:ListItem Text="Lead Source" Value="InquirySource" />
                                            <asp:ListItem Text="DisQualified Reason" Value="DisQualifiedReason" />
                                            <asp:ListItem Text="Followup" Value="Followup" />
                                            <asp:ListItem Text="Sales Order Approval" Value="SOApproval" />
                                            <asp:ListItem Text="Purchase Order Approval" Value="POApproval" />
                                            <asp:ListItem Text="Lead Priority" Value="LeadPriority" />
                                            <asp:ListItem Text="Complaint Status" Value="ComplaintStatus" />
                                            <asp:ListItem Text="Project Status" Value="ProjectStatus" />
                                            <asp:ListItem Text="Work Order Approval" Value="WOApproval" />
                                        </asp:DropDownList>
                                        <label class="active" for="txtCategory">Category</label>
                                    </div>
                                    <div class="input-field col m6">
                                        <asp:TextBox ID="txtInquiryStatus" runat="server" class="form-control" TabIndex="2" MaxLength="50" placeholder=""></asp:TextBox>
                                        <label type="label" ID="lblInquiryStatus" runat="server" clientidmode="Static" class="active" for="txtInquiryStatus">Inquiry Status / Source <span class="materialize-red-text font-weight-800">*</span></label>
                                    </div>
                            </div>
                        </div>
                    </div>
