<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Punch.aspx.cs" Inherits="StarsProject.Punch" %>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="input-field col m4">
                                            <asp:TextBox ID="txtPunchName" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="50" placeholder="" />
                                            <label class="active" for="txtPunchName">Punch Name <span class="materialize-red-text font-weight-800">*</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
