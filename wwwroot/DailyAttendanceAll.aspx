<%@ Page Language="C#" MasterPageFile="~/StarsSite.Master" AutoEventWireup="true" CodeBehind="DailyAttendanceAll.aspx.cs" Inherits="StarsProject.DailyAttendanceAll" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function openUploadDocument() {
            spnModuleHeader.innerText = "Upload Attendance";
