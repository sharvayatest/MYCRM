<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Document_Type.aspx.cs" Inherits="StarsProject.Document_Type" %>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="input-field col m4">
                                            <asp:TextBox ID="txtDocumentType" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="50" placeholder="" />
                                            <label class="active" for="txtDocumentType">Document Type <span class="materialize-red-text font-weight-800">*</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
