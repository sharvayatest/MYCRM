<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintVisit.aspx.cs" Inherits="StarsProject.ComplaintVisit" %>
    ...
    <form id="frmEntry" runat="server" autocomplete="off">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div class="widgetbox">
                ...
                <asp:HiddenField ID="hdnProductID" runat="server" ClientIDMode="Static" Value="0" />
                        ...
                        <div class="modal-body">
                                ...
                                <div class="input-field col m7">
                                    <div class="input-field col m12">
                                        ...
                                        <div class="input-field col m4">
                                            ...
                                            <asp:DropDownList ID="drpComplaintNo" runat="server" class="select2-theme browser-default" ClientIDMode="Static" AutoPostBack="true" OnTextChanged="drpComplaintNo_TextChanged" TabIndex="2"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="input-field col m12">
                                        ...
                                        <div class="input-field col m5">
                                            <label class="active" for="txtTimeFrom">Visit Timing <span class="materialize-red-text font-weight-800">*</span></label>
                            ...
                            <div class="row">
                                <div class="input-field col m4">
                                    ...
                                    <asp:TextBox ID="txtSrNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="7" placeholder="" />
                                </div>
                                <div class="input-field col m4">
                                    <label class="active" for="txtProductName">Product Name </label>
                                    <asp:TextBox ID="txtProductName" runat="server" class="form-control" ClientIDMode="Static" TabIndex="8" ReadOnly="true" placeholder="" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col m8">
                                    <label class="active" for="txtComplaintNotes">Complaint Description </label>
                                    <asp:TextBox ID="txtComplaintNotes" runat="server" class="form-control" ClientIDMode="Static" TabIndex="8" TextMode="MultiLine" Rows="3" ReadOnly="true" placeholder="" />
                                </div>
                            </div>
                            <div class="row mt-1">
                                <div class="input-field col m12">
                                    <label class="active" for="txtVisitNotes">Visit Notes <span class="materialize-red-text font-weight-800">*</span></label>
                                    <asp:TextBox ID="txtVisitNotes" runat="server" class="form-control" ClientIDMode="Static" TabIndex="9" MaxLength="1000" TextMode="MultiLine" Rows="4" style="height:200px;" placeholder="" />
                                </div>
                            </div>
