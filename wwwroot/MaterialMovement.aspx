<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialMovement.aspx.cs" Inherits="StarsProject.MaterialMovement" %>
                                                            ...
                                                            <asp:Repeater ID="rptProductDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptProductDetail_ItemCommand">
                                                                ...
                                                                <FooterTemplate>
                                                                    <tr style="padding: 5px;">
                                                                        ...
                                                                        <%--<td class="center-align">
                                                                            <asp:TextBox ID="txtClosingSTK" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' Style="width: 80px; text-align: right;"/> 
                                                                        </td>--%>
                                                                        <td class="center-align">
