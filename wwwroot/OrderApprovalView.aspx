<%@ Page Title="" Language="C#" MasterPageFile="~/StarsSite.Master" AutoEventWireup="true" CodeBehind="OrderApprovalView.aspx.cs" Inherits="StarsProject.OrderApprovalView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <uc1:myOrderApproval runat="server" ID="myOrderApproval" style="width:100%;" />
    <br /><br /><br /><br />
</asp:Content>
