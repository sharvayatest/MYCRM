<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesChallan.aspx.cs" Inherits="StarsProject.SalesChallan" %>
    ...
    <script type="text/javascript">
        ...
        function openSpecification(pProdID) {
            ...
            else
            {
                ...
                var pageUrl = "ProductSpecification.aspx?Module=salesChallan&DocNo=" + t11 + "&FinishProductID=" + pProdID;
            }
            //t11 = jQuery("#txtInvoiceNo").val();
                                        ...
                                        <div class="col m12">
                                            <div class="row">
                                                ...
                                                <div class="input-field col m2">
                                                    ...
                                                    <asp:DropDownList ID="drpLedger" runat="server" ClientIDMode="Static" TabIndex="4" class="select2-theme browser-default" Style="height: inherit;" />
                                                </div>
                                                <div class="input-field col m2">
                                                        ...
                                                        <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <% if (hdnSerialKey.Value == "SA98-6HY9-HU67-LORF")
                                                                            { %>
                                                                        <th class="right-align width-5">Unit Qty </th>
                                                                        <% } %>
                                                                        <th class="right-align width-6">Quantity <span class="materialize-red-text font-weight-800">*</span></th>
                                                                        <th class="center-align width-4">Unit</th>
                                                                        <th class="right-align width-6">Unit Rate<span class="materialize-red-text font-weight-800">*</span></th>
                                                                        <th class="right-align width-5">Disc. %</th>
                                                                        <th class="right-align width-7">Disc.Amt</th>
                                                                        <th class="right-align width-5">Net Rate</th>
                                                                        <th class="right-align width-6">Header Disc</th>
                                                                        <th class="right-align width-6">Amount</th>
                                                                        <th class="right-align width-5">Tax %</th>
                                                                        <th class="right-align width-7">Tax Amount</th>
                                                                        <th class="right-align hide">Add.Tax %</th>
                                                                        <th class="right-align hide">Add.Tax Amt</th>
                                                                        <th class="right-align width-7">Net Amount</th>
                                                                        <th id="tdOutwardNo" runat="server" class="center-align width-6">S.O #</th>
                                                                        <th class="center-align width-4 hide">Specs</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="edNetAmount" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="18" />
                                                                    </td>
                                                                    <td class="right-align width-4">
                                                                    ...
                                                                    <td class="center-align width-3 hide">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="80" Enabled="false" TabIndex="29" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                    ...
                                                                    <td class="center-align width-5">
                                                                        <asp:ImageButton ID="imgBtnSave" runat="server" ImageUrl="~/images/buttons/bt-add2.png" ToolTip="Add Item" CommandName="Save" CommandArgument='0' Width="110" Height="30" TabIndex="33" />
                                                                    </td>
                                                                </tr>
