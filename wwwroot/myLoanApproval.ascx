<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="myLoanApproval.ascx.cs" Inherits="StarsProject.myLoanApproval" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<script type="text/javascript">
    function viewLoanInfo(id) {
        var pageUrl = "Loan.aspx?mode=view&id=" + id;
    ...
    <asp:Repeater ID="rptApproval" runat="server" OnItemDataBound="rptApproval_ItemDataBound">
        <HeaderTemplate>
            <thead>
                <tr>
                    ...
                    <th class="center-align">Apply Date</th>
                    <th class="left-align">Employee Name</th>
                    <th class="center-align">Loan Type</th>
                    <th class="center-align">Loan Amount</th>
                    <th class="center-align">No.Of Installments</th>
                    <th class="center-align">Installment Amount</th>
        ...
        <ItemTemplate>
            <tr class="blueShed">
                ...
                <td class="center-align"> <%# Eval("LoanType") %></td>
                <td class="center-align"> <%# Eval("LoanAmount") %></td>
                <td class="center-align"> <%# Eval("NoOfInstallments") %></td>
                <td class="center-align"> <%# Eval("InstallmentAmount") %></td>
                <td class="center-align">
