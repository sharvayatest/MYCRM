<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderDealerSpecification.aspx.cs" Inherits="StarsProject.SalesOrderDealerSpecification" %>
                                ...
                                <div class="input-field col m12">
                                    <div class="profile-head">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="prodspec-tab" data-toggle="tab" href="#prodspec" role="tab" aria-controls="prodspec" aria-selected="true" aria-hidden="true">Product Specification</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <section class="our-webcoderskull padding-lg" style="height: 320px; overflow-y: auto;">
                                                <div class="container" style="max-width: none; width: 98%; margin: 5px !important;">
                                                    <div id="divRemarks" runat="server" clientidmode="Static" class="input-field col m">
                                                        ...
                                                        <asp:TextBox ID="txtRemarks" runat="server" class="form-control" ClientIDMode="Static" TabIndex="17" TextMode="MultiLine" Rows="7" MaxLength="500" />
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
