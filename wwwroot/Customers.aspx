<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="StarsProject.Customers" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function setHiddenControls() {
            var userData = JSON.stringify({ "pPageName": 'customer' });
            $.ajax({
                type: "POST",
                            ...
                            <div class="col m9">
                                <asp:UpdatePanel ID="uPnlBasicInfo" runat="server">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtContactNo1" class="form-control" runat="server" ClientIDMode="Static" Placeholder="" MaxLength="10" TabIndex="15"/>
                                            ...
                                            <div class="input-field col m5">
                                                ...
                                                <asp:TextBox ID="txtEmailAddress" class="form-control" runat="server" ClientIDMode="Static"  MaxLength="100" Placeholder="" TabIndex="7"  />
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col m2">
                                                ...
                                                <label class="active" for="txtCINNo"><% if (hdnSerialKey.Value == "BLUE-CHEM-56JK-BC88") { %>Aadhaar Card # <% } else {%> CIN # <%} %> </label>
                                            </div>
                                           <% if (hdnSerialKey.Value != "JAYJ-ALAR-AMBR-ICKS")
                                               { %>
                                            <div class="input-field col m3" visible="false">
                                         ...
                                         <div class="row">
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtTinVatNo" class="form-control" runat="server" ClientIDMode="Static" Placeholder="" MaxLength="15" TabIndex="18" />
                                                <label class="active" for="txtTinVatNo">TIN VAT No. </label>
                                            </div>
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtTinCstNo" runat="server" TabIndex="19" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="15" />
                                                <label class="active" for="txtTinCstNo">TIN CST No.</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col m12 pt-1">
                                            ...
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtOpening" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" TabIndex="20"  Placeholder="" AutoPostBack="true" OnTextChanged="txtOpening_TextChanged" MaxLength="12"/>
                                            </div>
                                        </div>
                                        <div class="col m12">
                                            Debit
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtDebit" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" ReadOnly="true"   Placeholder="" MaxLength="12"/>
                                            </div>
                                        </div>
                                        <div class="col m12">
                                            Credit
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtCredit" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" ReadOnly="true" Placeholder="" MaxLength="12"/>
                                            </div>
                                        </div>
                                        <div class="col m12">
                                            Closing
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtClosing" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" ReadOnly="true"   Placeholder="" MaxLength="12"/>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="card-content card-border-gray" style="height:500px;padding-top: 5px;">
                                        <div class="row">
                                            <ul id="myTab" class="tabs card-border-gray" runat="server" clientidmode="Static" enableviewstate="true">
                                                <li class="tab col m3 p-0"><a id="lnkcustaddress" class="left active" href="#custaddress">Multiple Address</a></li>
                                                <li class="tab col m3 p-0"><a id="lnkcustcont" class="left active" href="#custcont">Primary Contacts</a></li>
                                                <li class="tab col m3 p-0"><a id="lnkcustdocs" class="left" runat="server" clientidmode="Static" href="#custdocs">Documents</a></li>
                                                <% if (hdnCustWisePro.Value == "yes")
                                                    { %>
                                                <li class="tab col m3 p-0"><a id="lnkcustpro" class="left active" href="#custpro">Products</a></li>
                                                <%} %>
                                            </ul>
                                        </div>
                                                            ...
                                                            <div class="col m6 pr-0">
                                                                <div class="card small" style="height:350px;">
                                                                    <div class="card-title blue white-text" style="padding:10px;">
                                                                        <p class="no-margin">Billing Address</p>
                                                                    </div>
                                                                ...
                                                                <div class="card small" style="height:400px;">  
                                                                    ...
                                                                    <div class="card-content" style="padding:10px 5px 5px 5px  !important;">
                                                                        <div class="row" style="width:100%">
                                                                            ...
                                                                            <div class="input-field col m6">
                                                                                <asp:TextBox ID="txtShipToGSTNo" runat="server" TabIndex="34" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="20" />
                                                                        ...
                                                                        <div class="row" style="width:100%">
                                                                            ...
                                                                            <div class="input-field col m6">
                                                                                <asp:TextBox ID="txtPincode1" runat="server" TabIndex="40" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="10"/>
