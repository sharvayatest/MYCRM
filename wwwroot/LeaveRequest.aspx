<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveRequest.aspx.cs" Inherits="StarsProject.LeaveRequest" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/myLeaveBalances.ascx" TagPrefix="uc1" TagName="myLeaveBalances" %>
...
<body class="loginpage">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <%--<asp:UpdatePanel ID="upUserPanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>--%>
                <div class="row">
                    <uc1:myLeaveBalances runat="server" ID="myLeaveBalances" />
                </div>
                <div class="widgetbox">
                                    ...
                                    <div class="col m5">
                                        <div class="row">
                                            <div class="input-field col m12">
                                                <asp:TextBox ID="txtReasonForLeave" runat="server" class="textarea" ClientIDMode="Static" PlaceHolder=" " TabIndex="1" MaxLength="1000" TextMode="MultiLine" Height="100px" />
                                                <label class="active" for="txtReasonForLeave">Leave Applied For <span class="materialize-red-text font-weight-800">*</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col m7">
                                        ...
                                        <div class="row">
                                            <div class="input-field col m6">
                                                <asp:DropDownList ID="drpLeaveType" runat="server" class="select2-theme browser-default" ClientIDMode="Static" Width="200px" TabIndex="6">
                                                </asp:DropDownList>
                                                <label class="active" for="drpLeaveType">Type Of Leave</label>
                                            </div>
                                            <div class="input-field col m6">
