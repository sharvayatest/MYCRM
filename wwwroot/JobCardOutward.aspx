<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobCardOutward.aspx.cs" Inherits="StarsProject.JobCardOutward" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openSpecification(pProdID) {
            ...
            var pageUrl = "ProductSpecification.aspx?Module=jobcardoutward&DocNo=" + t11 + "&FinishProductID=" + pProdID;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
    </script>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="text-right center-align">
                                                                <asp:TextBox ID="edSerialNo" MaxLength="30" runat="server" ClientIDMode="Static" Text='<%# Eval("SerialNo") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 200px; text-align: left;"  />
                                                            </td>
                                                            <td class="text-right center-align">
                                                                <asp:TextBox ID="edBoxNo" MaxLength="10" runat="server" ClientIDMode="Static" Text='<%# Eval("BoxNo") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 200px; text-align: left;"  />
                                                            </td>
