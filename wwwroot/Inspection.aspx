<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inspection.aspx.cs" Inherits="StarsProject.Inspection" %>
                                ...
                                <div class="col m5" style="border-right: 3px ridge silver;">
                                    <div class="row">
                                        ...
                                        <div class="input-field col m6">
                                            ...
                                            <asp:TextBox ID="txtInspectionDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="2" onkeypress="return false;" placeholder="" TextMode="Date" />
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m6">
                                            <label class="active" for="drpOrder">Order No</label>
                                            <asp:DropDownList ID="drpOrder" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="5" />
                                        </div>
                                        <div class="input-field col m6">
                                            <label class="active" for="drpEmployee">Employee </label>
                                            <asp:DropDownList ID="drpEmployee" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="6" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col m7">
                                    <div class="row">
                                        <div class="input-field col m5">
                                            <label class="active" for="drpCheckList">Select Inspection Type : </label>
                                            <asp:DropDownList ID="drpCheckList" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="6" AutoPostBack="true" OnSelectedIndexChanged="drpCheckList_SelectedIndexChanged">                                                
                                                <asp:ListItem Text="- Select --" Value="" />
                                                <asp:ListItem Text="Fabrication" Value="Fabrication" />
                                                <asp:ListItem Text="Installation" Value="Installation" />
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                                            ...
                                                            <asp:Repeater ID="rptProductDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptProductDetail_ItemCommand" OnItemDataBound="rptProductDetail_ItemDataBound">
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <asp:HiddenField ID="hdnCheckFlag" runat="server" ClientIDMode="Static" Value='<%#Eval("CheckFlag") %>' />
                                                                        <td class="text-left width-50">
                                                                            <asp:TextBox ID="edCheckDesc" runat="server" ClientIDMode="Static" class="form-control" TabIndex="8" placeholder="" Text='<%# Eval("CheckDesc") %>' />
                                                                        </td>
                                                                        <td class="text-left width-10">
                                                                            <asp:DropDownList ID="edCheckFlag" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="6">                                                
                                                                                <asp:ListItem Text="Yes" Value="Yes" />
                                                                                <asp:ListItem Text="No" Value="No" />
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td class="text-left width-30">
                                                                            <asp:TextBox ID="edCheckRemark" runat="server" ClientIDMode="Static" class="form-control" TabIndex="8" placeholder=" " Text='<%# Eval("CheckRemark") %>' />
                                                                        </td>
                                                                        <td class="text-center width-10">
                                                                            <asp:ImageButton ID="ImgbtnUpdate" runat="server" ClientIDMode="Static" ImageUrl="~/images/expand.png" ToolTip="Update" CommandName="Update" CommandArgument='<%# Eval("pkID") %>' />
                                                                ...
                                                                <FooterTemplate>
                                                                    <tr style="padding: 5px;">
                                                                        <td class="width-50">
                                                                            ...
                                                                            <asp:TextBox ID="txtCheckDesc" runat="server" ClientIDMode="Static" class="form-control" TabIndex="8" placeholder="" />
                                                                        </td>
                                                                        <td class="text-left width-10">
                                                                            <asp:DropDownList ID="txtCheckFlag" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="6">                                                
                                                                                <asp:ListItem Text="Yes" Value="Yes" />
                                                                                <asp:ListItem Text="No" Value="No" />
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td class="text-left width-30">
                                                                            <asp:TextBox ID="txtCheckRemark" runat="server" ClientIDMode="Static" class="form-control" TabIndex="8" placeholder="" />
                                                                        </td>
                                                                        <td class="text-center width-10">
