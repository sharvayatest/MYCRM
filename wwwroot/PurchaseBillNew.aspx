<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseBillNew.aspx.cs" Inherits="StarsProject.PurchaseBillNew" %>
            ...
            <ContentTemplate>--%>
                ...
                <div class="widgetbox">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="input-field col m2">
                                        ...
                                        <asp:TextBox ID="txtInvoiceNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="1" readonly="true" placeholder="" />
                                    </div>
                                    <div class="input-field col m2">
                                        <label class="active" for="txtInvoiceDate">Invoice Date</label>
                                        <asp:TextBox ID="txtInvoiceDate" runat="server" class="form-control" TextMode="Date" ClientIDMode="Static" TabIndex="2" placeholder="" />
                                    </div>
                                    <div class="input-field col m4">
                                        ...
                                        <asp:TextBox ID="txtCustomerName" runat="server" ClientIDMode="Static" class="form-control" onKeyup="bindDDLTo('#txtCustomerName')" AutoPostBack="true"  TabIndex="3" placeholder="" OnTextChanged ="txtCustomerName_TextChanged"/>
                                    </div>
                                    <div class="input-field col m2">
                                        <label class="active" for="drpState">Purchase A/c <span class="materialize-red-text font-weight-800">*</span></label>
                                        <asp:DropDownList ID="drpLedger" runat="server" ClientIDMode="Static" TabIndex="4" data-placeholder="Select ..." class="select2-theme browser-default"/>
                                    </div>
                                    <div class="input-field col m2">
                                        <label class="active" for="drpBank">Select Bank <span class="materialize-red-text font-weight-800">*</span></label>
                                        <asp:DropDownList ID="drpBank" runat="server" ClientIDMode="Static" TabIndex="5" data-placeholder="Select ..." class="select2-theme browser-default"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col m2">
                                        <label class="active" for="drpTerminationOfDelivery">Termination Of Delivery</label>
                                        <asp:DropDownList ID="drpTerminationOfDelivery" runat="server" ClientIDMode="Static" TabIndex="6" class="select2-theme browser-default" data-placeholder="Select ..." AutoPostBack="true" OnSelectedIndexChanged="drpTerminationOfDelivery_SelectedIndexChanged" />
                                    </div>
                                    <div class="input-field col m2">
                                        <label class="active" for="txtBillNo">Supp.Bill #</label>
                                        <asp:TextBox ID="txtBillNo" runat="server" ClientIDMode="Static" TabIndex="7" class="form-control" placeholder=""/>                                        
                                    </div>
                                    <div class="col m8">
                                        <% if (hdnLocationStock.Value == "yes")
                                         {%>
                                            <div class="input-field col m2">
                                                ...
                                                <asp:DropDownList ID="drpLocation" runat="server" ClientIDMode="Static" TabIndex="8" class="select2-theme browser-default" data-placeholder="Select ..." />
                                            </div>
                                        <%}%>
                                       <div id="dvLoadItems" runat="server" class="row" visible="false">
                                            <div class="input-field col m2">
                                                <label class="active" for="rdblOption">Select Option</label>
                                                <asp:DropDownList ID="rdblOption" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" data-placeholder="Select ..." AutoPostBack="true" OnSelectedIndexChanged="rdblOption_SelectedIndexChanged" TabIndex="9">
                                            ...
                                            <div class="input-field col m6">
                                                ...
                                                <asp:DropDownList ID="drpReferenceNo" runat="server" ClientIDMode="Static" TabIndex="10" data-placeholder="Select ..." CssClass="select2-size-sm browser-default" multiple="multiple" />
                                            </div>
                                            <div class="input-field col m2">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="right-align width-5">
                                                                    <asp:TextBox ID="edUnit" runat="server" ClientIDMode="Static" Text='<%# Eval("Unit") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="63" />
                                                                </td>
                                                                ...
                                                                <td class="text-right width-5">
                                                                    <asp:TextBox ID="edDiscountPercent" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="65" />
                                                                </td>
                                                                ...
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox ID="edNetAmount" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmt") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="74"/>
                                                                </td>
                                                                <td class="right-align width-7">
                                                        ...
                                                        <FooterTemplate>
                                                            <tr style="background-color: #dde8f3;">
                                                                <td class="left" style="width:190px;">
                                                                    ...
                                                                    <asp:TextBox ID="txtProductName" runat="server" ClientIDMode="Static" class="form-control" onKeyup="bindDDLProductTo('#txtProductName')" AutoPostBack="true" OnTextChanged="txtProductName_TextChanged" TabIndex="12" />
                                                                </td>
                                                                <td class="right-align width-7">
                                                                    <asp:TextBox CssClass="OnlyNumeric" ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" TabIndex="13" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" />
                                                                </td>
                                                                <td class="right-align width-5">
                                                                    <asp:TextBox ID="txtUnit" runat="server" ClientIDMode="Static" Width="70" TabIndex="14" AutoPostBack="true" OnTextChanged="txtUnit_TextChanged" />
                                                                </td>
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox CssClass="OnlyDecimal" ID="txtUnitRate" runat="server" ClientIDMode="Static" Width="80" TabIndex="15" AutoPostBack="true" OnTextChanged="txtUnitRate_TextChanged" />
                                                                </td>
                                                                <td class="text-right width-5">
                                                                    <asp:TextBox ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="50" TabIndex="22" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                </td>
                                                                <td class="text-right width-6">
                                                                    <asp:TextBox ID="txtDiscountAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="16" AutoPostBack="true" OnTextChanged="txtDiscountAmt_TextChanged" />
                                                                </td>
                                                                <td class="text-right width-6">
                                                                    <asp:TextBox ID="txtNetRate" runat="server" ClientIDMode="Static" Width="80" TabIndex="17" Enabled="false" />
                                                                </td>
                                                                <td class="text-right width-5">
                                                                    <asp:TextBox ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="60" TabIndex="18" Enabled="false" />
                                                                </td>
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox ID="txtAmount" runat="server" ClientIDMode="Static" Width="90" TabIndex="19" Enabled="false" />
                                                                </td>
                                                                <td class="right-align width-5">
                                                                    ...
                                                                    <asp:TextBox ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="50" TabIndex="20" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                </td>
                                                                <td class="right-align width-7">
                                                                    ...
                                                                    <asp:TextBox ID="txtTaxAmount" runat="server" ClientIDMode="Static" Width="90" TabIndex="21" Enabled="false" />
                                                                </td>
                                                                <td class="right-align width-5">
                                                                    <asp:TextBox ID="txtAddTaxPer" runat="server" ClientIDMode="Static" Width="50" TabIndex="22" AutoPostBack="true" OnTextChanged="txtAddTaxPer_TextChanged" />
                                                                </td>
                                                                <td class="left-align width-7">
                                                                    <asp:TextBox ID="txtAddTaxAmt" runat="server" ClientIDMode="Static" Width="90" TabIndex="23" Enabled="false" />

                                                                </td>
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox ID="txtNetAmount" runat="server" ClientIDMode="Static" Width="90" TabIndex="24" Enabled="false" />
                                                                </td>
                                                                <td class="right-align width-7">
                                                                    <asp:DropDownList ID="drpOrderNo" runat="server" ClientIDMode="Static" TabIndex="17" CssClass="select2-theme browser-default" data-placeholder="Select ..." />
                                                                </td>
                                                                <td class="center-align width-5">
                                                    ...
                                                    <div class="col m4">
                                                        ...
                                                        <table id="tblCharge" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="width-70">
                                                                        <asp:DropDownList ID="drpOthChrg1" runat="server" class="select2-theme browser-default" data-placeholder="Select ..." EnableViewState="true" ClientIDMode="Static" TabIndex="26" AutoPostBack="true" OnSelectedIndexChanged="drpOthChrg1_SelectedIndexChanged" />
                                                                    </td>
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="27" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                        <asp:DropDownList ID="drpOthChrg2" runat="server" class="select2-theme browser-default" data-placeholder="Select ..." EnableViewState="true" ClientIDMode="Static" TabIndex="28" AutoPostBack="true" OnSelectedIndexChanged="drpOthChrg2_SelectedIndexChanged" />
                                                                    </td>
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="29" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                        <asp:DropDownList ID="drpOthChrg3" runat="server" class="select2-theme browser-default" data-placeholder="Select ..." EnableViewState="true" ClientIDMode="Static" TabIndex="30" AutoPostBack="true" OnSelectedIndexChanged="drpOthChrg3_SelectedIndexChanged" />
                                                                    </td>
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="31" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                        <asp:DropDownList ID="drpOthChrg4" runat="server" class="select2-theme browser-default" data-placeholder="Select ..." EnableViewState="true" ClientIDMode="Static" TabIndex="32" AutoPostBack="true" OnSelectedIndexChanged="drpOthChrg4_SelectedIndexChanged" />
                                                                    </td>
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="33" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                        <asp:DropDownList ID="drpOthChrg5" runat="server" class="select2-theme browser-default" data-placeholder="Select ..." EnableViewState="true" ClientIDMode="Static" TabIndex="34" AutoPostBack="true" OnSelectedIndexChanged="drpOthChrg5_SelectedIndexChanged" />
                                                                    </td>
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="35" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" />
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tbody>
                                                                <tr class="border-none">
                                                                    ...
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="36" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    <td class="width-80 right-align">Basic Amount</td>
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtTotBasicAmt" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="37" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    ...
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtTotOthChrgBeforeGST" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="38" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    ...
                                                                    <td class="width-20">
                                                                        ...
                                                                        <asp:TextBox ID="txtTotGST" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="39" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    ...
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtTotAddTaxAmt" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="40" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    ...
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtTotOthChrgAfterGST" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="41" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    <td class="width-80 right-align">Round Off</td>
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtRoff" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="42" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
                                                                    <td class="width-80 right-align">Net Amount</td>
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtTotNetAmt" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="43" ReadOnly="true" Style="font-weight: bold;" />
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                    ...
                                    <div id="pnl_TNC" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display:none;">
                                          <div class="row">
                                                    <div class="input-field col m12">
                                                        ...
                                                        <asp:DropDownList ID="drpTNC" runat="server" ClientIDMode="Static" data-placeholder="Select ..." class="select2-theme browser-default" EnableViewState="true" TabIndex="44" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="drpTNC_SelectedIndexChanged" />
                                                    </div>
                                                    <div class="input-field col m12">
                                                        <label class="active" for="txtTermsCondition">Terms & Condition</label>
                                                        <asp:TextBox ID="txtTermsCondition" runat="server" class="form-control" ClientIDMode="Static" TabIndex="45" TextMode="MultiLine" Rows="20" Height="200px" placeholder="" />
                                                    </div>
                                                </div> 
                                    </div>
                                        ...
                                        <div class="container" style="max-width: none; width: 98%; margin: 5px !important;">
                                            <div class="row">
                                                <div class="input-field col m3">
                                                    ...
                                                    <asp:DropDownList ID="drpModeOfTransport" runat="server" data-placeholder="Select ..." class="select2-theme browser-default" TabIndex="46">
                                                ...
                                                <div class="input-field col m3">
                                                    ...
                                                    <asp:TextBox ID="txtTransporterName" runat="server" class="form-control" ClientIDMode="Static" TabIndex="47" placeholder="" />
                                                </div>
                                                <div class="input-field col m3">
                                                    <label class="active" for="txtVehicleNo">Vehicle No.</label>
                                                    <asp:TextBox ID="txtVehicleNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="48" placeholder="" />
                                                </div>
                                                <%-- <div class="input-field col m3">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m3">
                                                    ...
                                                    <asp:TextBox ID="txtLRNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="49" placeholder="" />
                                                </div>
                                                <div class="input-field col m3">
                                                    <label class="active" for="txtLRDate">LR Date/DC Date</label>
                                                    <asp:TextBox ID="txtLRDate" runat="server" class="form-control" TextMode="Date" ClientIDMode="Static" TabIndex="50" placeholder="" />
                                                </div>
                                                <%--<div class="input-field col m3">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m6">
                                                    ...
                                                    <asp:TextBox ID="txtTransportRemark" runat="server" class="form-control" ClientIDMode="Static" TabIndex="51" placeholder="" TextMode="MultiLine" MaxLength="1000" Rows="4" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row padding-1 gradient-45deg-blue-grey-blue-grey vertical-align-bottom" style="margin-top: 10px;">
                        <div class="col m12">
                            <button type="button" id="btnReset" runat="server" clientidmode="Static" class="btn orange left" onserverclick="btnReset_Click" tabindex="52"><i class="material-icons left">backspace</i>Clear & Add New</button>
                            <button type="button" id="btnSaveEmail" runat="server" clientidmode="Static" class="btn cyan  right mr-1" onserverclick="btnSaveEmail_Click" tabindex="53"><i class="material-icons left">email</i>Save - Send Email</button>
                            <button type="button" id="btnSave" runat="server" clientidmode="Static" class="btn cyan right mr-1" onserverclick="btnSave_Click" tabindex="54"><i class="material-icons left">save</i>Save</button>
                        </div>
                    </div>
                </div>
<%--            </ContentTemplate>
