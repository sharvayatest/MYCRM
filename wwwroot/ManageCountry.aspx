<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCountry.aspx.cs" Inherits="StarsProject.ManageCountry" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            var validflag = true;
            // ----------------------------------------
            if (jQuery("#txtCountryName").val().trim() == "") {

                if (jQuery("#txtCountryName").val().trim() == "")
                    errmsg += "Country Name is required</br>";
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="input-field col m7">
                                            <label class="active required" for="txtCountryName">Country Name</label>
                                            <asp:TextBox ID="txtCountryName" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="1000" />
                                        </div>
                                        <div class="input-field col m5">
                                            <label class="active required" for="txtCountryName">Country ISO <small class="text-muted font-italic">(International 2 Char ISO Code)</small></label>
                                            <asp:TextBox ID="txtCountryISO" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="2" />
                                        </div>

                                    </div>
                                    <div class="row">
                                        <div class="input-field col m">
                                            <label class="active" for="txtCountryName">Currency Symbol</label>
                                            <asp:DropDownList ID="ddlCurrency" runat="server" class="form-control" ClientIDMode="Static" TabIndex="2"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
