<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderAssembly.aspx.cs" Inherits="StarsProject.SalesOrderAssembly" %>
                                ...
                                <asp:Repeater ID="rptQuotationAssembly" runat="server" ClientIDMode="Static" OnItemCommand="rptQuotationAssembly_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <asp:HiddenField ID="edFinishProductID" runat="server" ClientIDMode="Static" Value='<%# Eval("FinishedProductID") %>' />
