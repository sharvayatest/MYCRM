...
jQuery(document).ready(function(){
	...
	jQuery('.checkall, .checkall2').on('click',function(){
	...
	jQuery('.stdtable .delete').on('click',function(){
	...
	jQuery('.quickview').on('click', function(){
	...
	jQuery('.quickformbutton .update').on('click',function(){
		jQuery(this).parent().find('.loading').show();
		return false;
	});
	
	///// QUICK VIEW CANCEL BUTTONS /////
	jQuery('.quickformbutton .cancel').on('click', function(){
	...
	jQuery('.hornav li.more > a').on('click',function(){
