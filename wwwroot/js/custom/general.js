...
jQuery(document).ready(function () {
    ...
    jQuery('.userinfo').click(function () {
        ...
        jQuery('.crmNoti').removeClass('active');
        jQuery('.crmNotiContent').hide();

        //remove notification box if visible
        jQuery('.crmCal').removeClass('active');
        jQuery('.crmCalContent').hide();


        return false;
    });

    jQuery('.crmNoti').click(function () {
        if (!jQuery(this).hasClass('active')) {
            jQuery('.crmNotiContent').show();
            jQuery(this).addClass('active');
        } else {
            jQuery('.crmNotiContent').hide();
            jQuery(this).removeClass('active');
    ...
    jQuery('.crmCal').click(function () {
        if (!jQuery(this).hasClass('active')) {
            jQuery('.crmCalContent').show();
            jQuery(this).addClass('active');
        } else {
            jQuery('.crmCalContent').hide();
            jQuery(this).removeClass('active');
    ...
    jQuery(document).click(function (event) {
        ...
        var crmnoti = jQuery('.crmNotiContent');
        var crmcal = jQuery('.crmCalContent');
        ...
        //hide user drop menu when clicked outside of this element
        if (!jQuery(event.target).is('.crmNotiContent') && !jQuery(event.target).is('.crmNotiData') && crmnoti.is(':visible')) {
            crmnoti.hide();
            jQuery('.crmNoti').removeClass('active');
        }

        //hide user drop menu when clicked outside of this element
        if (!jQuery(event.target).is('.crmCalContent') && !jQuery(event.target).is('.crmCalData') && crmcal.is(':visible')) {
            crmcal.hide();
            jQuery('.crmCal').removeClass('active');
        }
    ...
    //jQuery('.vernav > ul li a, .vernav2 > ul li a.level1').each(function () {
    ...
    //jQuery('.vernav2 > ul li > ul li a.level2').each(function () {
    //    var url = jQuery(this).attr('href');
    //    jQuery(this).click(function () {
    //        if (jQuery(url).length > 0) {
    //            if (jQuery(url).is(':visible')) {
    ...
    //                    jQuery(url).slideUp();
    //            } else {
    //                jQuery('.vernav2 ul ul ul').each(function () {
    //                    jQuery(this).slideUp();
    //                });
    //                if (!jQuery(this).parents('div').hasClass('menucoll') && !jQuery(this).parents('div').hasClass('menucoll2')) {
    //                    jQuery(url).slideDown();
    ...
    //jQuery('.vernav2 > ul li > ul li > ul li a.level3').each(function () {
    //    var url = jQuery(this).attr('href');
    //    jQuery(this).click(function () {
    //        if (jQuery(url).length > 0) {
    //            if (jQuery(url).is(':visible')) {
    ...
    //                    jQuery(url).slideUp();
    //            } else {
    //                jQuery('.vernav2 ul ul ul ul').each(function () {
    //                    jQuery(this).slideUp();
    //                });
    //                if (!jQuery(this).parents('div').hasClass('menucoll') && !jQuery(this).parents('div').hasClass('menucoll2')) {
    //                    jQuery(url).slideDown();
    ...
    jQuery('.menucoll > ul > li, .menucoll2 > ul > li.lilevel1').on('mouseenter mouseleave', function (e) {
        if (e.type == 'mouseenter') {
            jQuery(this).addClass('hover');
            jQuery(this).find('ul').eq(0).show();
        } else {
            jQuery(this).removeClass('hover').find('ul').eq(0).hide();
        }
    });

    jQuery('.menucoll2 > ul > li.lilevel1 > ul > li.lilevel2').on('mouseenter mouseleave', function (e) {
        if (e.type == 'mouseenter') {
            jQuery(this).addClass('hover');
            jQuery(this).find('ul').eq(0).show();
        } else {
