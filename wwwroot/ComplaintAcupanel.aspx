<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintAcupanel.aspx.cs" Inherits="StarsProject.ComplaintAcupanel" %>
                            ...
                            <div class="input-field col m12">
                                <div class="row">
                                    ...
                                    <div class="input-field col m6">
                                        ...
                                        <asp:TextBox ID="txtCompanyEmailID" runat="server" class="form-control" ClientIDMode="Static" TabIndex="2" placeholder="" />
                                    </div>
                                </div>
                                <div class="row">

                                    <div class="input-field col m3">
                                        <label class="active" for="txtMobileNo">Primary Contact<span class="materialize-red-text font-weight-800">*</span></label>
                                        <asp:TextBox ID="txtMobileNo" runat="server" class="form-control" ClientIDMode="Static" MaxLength="18"  TabIndex="3" placeholder="" />
                                    </div>
                                    <div class="input-field col m3">
                                        <label class="active" for="txtName">Primary Contact Person<span class="materialize-red-text font-weight-800">*</span></label>
                                        <asp:TextBox ID="txtName" runat="server" class="form-control" ClientIDMode="Static" MaxLength="50" TabIndex="4" placeholder="" />
                                    </div>
                                    <div class="input-field col m3">
                                        <label class="active" for="txtDesignation">Designation<span class="materialize-red-text font-weight-800">*</span></label>
                                        <asp:TextBox ID="txtDesignation" runat="server" class="form-control" ClientIDMode="Static" TabIndex="5" placeholder="" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col m6">
                                    ...
                                    <div class="input-field col m6">
                                        <div class="row">
                                            ...
                                            <div class="input-field col m4">
                                                ...
                                                <asp:DropDownList id="drpState" runat="server" CssClass="browser-default" ClientIDMode="Static" TabIndex="12" AutoPostBack="true"  OnSelectedIndexChanged="drpState_SelectedIndexChanged1"/>
                                            </div>
                                            <div class="input-field col m4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col m3">
                                        <label class="active" for="txtConvinientDate">Convinient Date<span class="materialize-red-text font-weight-800">*</span></label>
