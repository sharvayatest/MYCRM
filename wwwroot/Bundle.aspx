<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bundle.aspx.cs" Inherits="StarsProject.Bundle" %>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="input-field col m4">
                                            <asp:TextBox ID="txtBundleName" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="50" placeholder="" />
                                            <label class="active" for="txtBundleName">Bundle Name <span class="materialize-red-text font-weight-800">*</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
