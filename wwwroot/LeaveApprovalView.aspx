<%@ Page Title="" Language="C#" MasterPageFile="~/StarsSite.Master" AutoEventWireup="true" CodeBehind="LeaveApprovalView.aspx.cs" Inherits="StarsProject.LeaveApprovalView" %>
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveApprovalView.aspx.cs" Inherits="StarsProject.LeaveApprovalView" %>--%>
