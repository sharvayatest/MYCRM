<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashVoucher.aspx.cs" Inherits="StarsProject.CashVoucher" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div runat="server" class="input-field col m2" visible="false">
                                ...
                                <div class="input-field col m3 hide">
                                    ...
                                    <asp:RadioButtonList class="form-control" ID="rdblTransType" runat="server" RepeatDirection="Horizontal" TabIndex="5">
                            ...
                            <div class="row">
                                <div class="col m12" style="background-color: #efe6e6; padding: 15px; border: 2px solid silver; border-radius: 5px;margin: 0px 0px 0px 15px;width: 97%;">
                                    <div class="row">
                                        <div class="input-field col m3">
                                            <label class="active" runat="server" clientidmode="Static" id="lblAccountName" for="txtAccountName">Debit A/c Name<small class="text-muted font-italic">&nbsp;(Min 3 chars to search)</small> <span class="materialize-red-text font-weight-800">*</span></label>
                                        ...
                                        <div class="input-field col m3">
                                            <label class="active" runat="server" clientidmode="Static" id="lblCustomerName" for="txtCustomerName">Credit A/c Name<small class="text-muted font-italic">&nbsp;(Min 3 chars to search)</small> <span class="materialize-red-text font-weight-800">*</span></label>
                            ...
                            <div class="row mt-1 badge-secondary" style="border-radius: 5px; padding: 5px;">
                                ...
                                <div class="input-field col m6">
                                    ...
                                    <table id="tblPay" class="stdtable" cellpadding="0" cellspacing="0" border="0" width="100%">
