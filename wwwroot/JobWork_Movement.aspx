<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobWork_Movement.aspx.cs" Inherits="StarsProject.JobWork_Movement" %>
                                ...
                                <div class="col m12" style="border-right: 3px ridge silver;">
                                   <div class="row">
                                        ...
                                        <div class="input-field col m2">
                                            ...
                                            <asp:DropDownList ID="drpOrder" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="5" AutoPostBack="true" OnSelectedIndexChanged="drpOrder_SelectedIndexChanged"/>
                                        </div>
                                                            ...
                                                            <asp:Repeater ID="rptProductDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptProductDetail_ItemCommand" OnItemDataBound="rptProductDetail_ItemDataBound">
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <% if (hdnTransType.Value == "in")
                                                                                 { %>
                                                                                <th id="htorderproduct" class="center-align width-20" >Order Products</th>
                                                                             <% } %>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td id="tdQuantity" class="center-align"><%# Eval("Quantity") %></td>
                                                                        <% if (hdnTransType.Value == "in")
                                                                         { %>
                                                                         <td id="itOrderProduct" class="center-align width-20" >
                                                                            <%# Eval("OrderProduct") %>
                                                                         </td>
                                                                        <% } %>
                                                            ...
                                                            <div class="col m12">
                                                                <table>
                                                                    <tr style="padding: 5px;">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <asp:TextBox ID="txtQuantity" runat="server" ClientIDMode="Static" Width="80" TabIndex="8" MaxLength="15" />
                                                                        </td>
                                                                        <% if (hdnTransType.Value == "in")
                                                                         { %>
                                                                          <td id="ftOrderPorduct" class="left-align width-20">
                                                                              <asp:HiddenField ID="hdnOrderProductID" runat="server" ClientIDMode="Static" />
                                                                             <asp:DropDownList ID="drpOrderProduct" runat="server" ClientIDMode="Static"  TabIndex="47" CssClass="select2-theme browser-default" />
                                                                          </td>
                                                                         <% } %>
                                                                        <td class="center-align">
                                                                            <asp:ImageButton ID="imgBtnSave" runat="server" ClientIDMode="Static" ImageUrl="~/images/expand.png" ToolTip="Add Item" onClick="imgBtnSave_Click" Width="20" Height="20" TabIndex="9" />
                                                                        </td>
