<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MissedPunch.aspx.cs" Inherits="StarsProject.MissedPunch" %>
...
<body class="loginpage">
    <form id="frmMissedPunch" runat="server" autocomplete="off">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col m3">
                                    <label class="active" for="txtPresenceDate">Miss Punch Date</label>
                                    <asp:TextBox ID="txtPresenceDate" runat="server" class="form-control" TextMode="Date" PlaceHolder="From Date" onkeypress="return false;" onpaste="return false" ClientIDMode="Static" Width="150px" TabIndex="2" />
                                        
                                </div>
                                <div class="input-field col m3">
                                    <label class="active" for="txtTimeIn">Time IN</label>
                                    <asp:TextBox ID="txtTimeIn" runat="server" class="timepicker" PlaceHolder="From Time" onkeypress="return false;" onpaste="return false" ClientIDMode="Static" Width="100px" TabIndex="3" />
                                </div>
                                <div class="input-field col m3">
                                    <label class="active" for="txtTimeOut">Time Out</label>
                                    <asp:TextBox ID="txtTimeOut" runat="server" class="timepicker" PlaceHolder="To Time" onkeypress="return false;" onpaste="return false" ClientIDMode="Static" Width="100px" TabIndex="5" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col m12">
                                    <label class="active" for="txtNotes">Notes</label>
                                    <asp:TextBox ID="txtNotes" runat="server" class="textarea" ClientIDMode="Static" Rows="3" PlaceHolder=" " TabIndex="1" MaxLength="1000" TextMode="MultiLine" Height="100px" />
                                </div>
                            </div>
                        </div>
                    </div>
