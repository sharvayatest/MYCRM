<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="myPurchaseApproval.ascx.cs" Inherits="StarsProject.myPurchaseApproval" %>
...
<asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" Style="display: none; border-radius: 10px; padding-right: 10px !important;">
    ...
    <iframe id="ifrModulePurchase" src="about:blank" runat="server" clientidmode="static" scrolling="auto" style="border: 1px solid silver; background-color: transparent; width: 100%; height: 90%; padding: 5px;"></iframe>
    <br />
</asp:Panel>
